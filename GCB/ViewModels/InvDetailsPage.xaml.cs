...
namespace GCB.ViewModels
{
    ...
    /// </summary>
    public sealed partial class InvDetailsPage : Page
    {
        ...
        public InvDetailsPage()
        {
            ...
            this.navigationHelper.GoBackCommand = new GCB.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (investmentDetailsData!= null)
            {
                ...
                this.DefaultViewModel["Group"] = investmentDetailsData.InvDetDatas[0].data.data;
